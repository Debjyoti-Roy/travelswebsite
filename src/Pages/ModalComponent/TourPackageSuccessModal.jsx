...
const TourPackageSuccessModal = ({ bookingId, queryType, total, travelDate, numberofpeople, message, onClose }) => {
        ...
        >
            <div className="bg-white rounded-lg overflow-hidden shadow-xl w-full max-w-md">
                <div className="bg-blue-600 text-white text-center py-4 relative">
                    <h2 className="text-lg font-semibold">Booking Exquiry created</h2>
                            ...
                            <div className="w-[90%] pt-6 pb-6">
                                <div className="grid grid-cols-2 gap-2">
                                    ...
                                    <div className="p-2 flex flex-col">
                                        ...
                                        <span className="text-md font-medium text-gray-800">{numberofpeople}</span>
                                    </div>

                                    <div className="p-2 flex flex-col">
                                        <span className="text-sm text-gray-600">Query type</span>
                                        <span className="text-md font-medium text-gray-800">{queryType}</span>
                                    </div>
                                    <div className="p-2 flex flex-col">

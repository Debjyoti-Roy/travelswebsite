...
import { addCars } from "../../Redux/store/partnerCar";
import toast from "react-hot-toast";

const AddCar = ({ counter }) => {
    ...
    const { status, error } = useSelector((state) => state.partnerCar);
    ...
    const handleSubmit = async (e) => {
        ...
        const resultAction = await dispatch(addCars({ token, body: formData }));
        if (addCars.fulfilled.match(resultAction)) {

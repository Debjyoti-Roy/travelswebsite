        ...
        <div className="pb-6">
          <div className="flex justify-between items-center pb-3">
            <div className="flex items-center gap-2">
              <Clock
                className={`w-5 h-5 ${
                  ["INITIATED", "COMPLETED"].includes(refundStatus.refundStatus)
                    ? "text-blue-600"
                    : "text-red-500"
                }`}
              />
                ...
                {/* {showRefundModal && refundStatus && (
                  ...
                  >
                    <div 
                      ...
                      onClick={(e) => e.stopPropagation()}
                    >
                      <h2 className="text-xl font-bold mb-4">Refund Status</h2>
                      ...
                      <div className="mb-6">
                        <div className="flex items-center justify-between mb-2">
                          <div className="flex items-center">
                            ...
                            <span className="ml-2 text-sm font-medium">INITIATED</span>
                          </div>
                          <div className="flex items-center">
                            <span className="text-sm font-medium">COMPLETED</span>
                            <div className={`w-4 h-4 rounded-full ml-2 ${
                              refundStatus.refundStatus === "COMPLETED" 
                                ? "bg-blue-500" 
                                : "bg-gray-300"
                            }`}></div>
                      ...
                      <div className="space-y-3 mb-6">
                        <div className="flex justify-between">
                          ...
                          <span className="font-semibold">₹{refundStatus.refundAmount}</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-gray-600">Cancel Reason:</span>
                          <span className="font-semibold">{refundStatus.cancelReason}</span>
                        </div>
                        <div className="flex justify-between">
                      ...
                      {refundStatus.refundStatus === "INITIATED" && (
                        <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-4">
                          <p className="text-blue-800 text-sm">
                            Your money will be refunded within 5-7 business days
                          </p>
                        </div>
                      )}
